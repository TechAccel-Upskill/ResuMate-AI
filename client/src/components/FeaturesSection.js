...
function FeaturesSection() {
    ...
    return (
        <section
            id="features"
            ref={sectionRef}
            className="relative py-20 lg:py-28 overflow-hidden bg-slate-50 dark:bg-[#0a0f1a]"
        >
            ...
            <div className="max-w-[1400px] mx-auto px-4 md:px-6 relative z-10">
                ...
                <div className={`text-center max-w-3xl mx-auto mb-16 transition-all duration-700 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
                    <div className="inline-flex items-center gap-2 border border-cyan-500/30 rounded-md px-3 py-1 mb-6">
                        <span className="text-xs font-semibold text-cyan-500 dark:text-cyan-400 uppercase tracking-wider">ENTERPRISE INTELLIGENCE</span>
                    </div>

                    <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold tracking-tight text-slate-900 dark:text-white mb-4 leading-tight">
                        Everything You Need for <br className="hidden sm:block" />
                        <span className="text-cyan-500 dark:text-cyan-400">Smarter Hiring</span>
                    </h2>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 lg:gap-6">
                    {features.map((feature, index) => (
                        <div
                            key={index}
                                className={`group relative bg-gradient-to-br from-white to-slate-50 dark:from-slate-900/40 dark:to-slate-800/20 backdrop-blur-sm border border-slate-200 dark:border-slate-700/40 rounded-xl p-6 transition-all duration-500 hover:scale-[1.02] hover:border-cyan-500/50 hover:shadow-xl hover:shadow-cyan-500/10 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-12'
                                }`}
                            style={{
                        ...
                        >
                            ...
                            <div className="relative mb-5">
                                <div className="inline-flex items-center justify-center w-12 h-12 rounded-lg border-2 border-cyan-500/60 bg-cyan-500/5 group-hover:border-cyan-400 group-hover:bg-cyan-500/10 transition-all duration-500 group-hover:shadow-lg group-hover:shadow-cyan-500/20">
                                    <span className="material-icons text-cyan-500 dark:text-cyan-400 text-2xl group-hover:scale-110 transition-transform duration-500">
                                        {feature.icon}
                                    </span>
                                </div>
                            </div>
                            ...
                            {/* Content */}
                            <h3 className="text-lg font-bold text-slate-900 dark:text-white mb-2.5 group-hover:text-cyan-500 dark:group-hover:text-cyan-400 transition-colors duration-300">
                                {feature.title}
                            </h3>

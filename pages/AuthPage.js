    ...
    <div className="auth-container">
      <div className="auth-left">
        ...
        <div className="hero">
          ...
          {/* Block 1: ATS MATCH */}
          <div className="illus-block block-1">
          ...
          {/* Block 2: SENIOR DEV */}
          <div className="illus-block block-2">
            <div className="block-header">
          ...
          {/* Block 3: BULK UPLOAD */}
          <div className="illus-block block-3">
            <div className="block-header">
              <svg className="w-4 h-4 text-gray-400 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="illus-block block-4">
          ...
          {/* Block 5: MAIL SENT */}
          <div className="illus-block block-5">
